  ...
  const glide = useCallback(
    (target: number) => {
      ...
      const step = (now: number) => {
        ...
        clips.forEach((clip) => {
          clip.playbackRate = rate.current;
        });
    ...
    >
      ...
      >
        {facets.map((facet) => (
          ...
          >
            <div className="flex h-full w-full flex-col justify-center" style={{ gap: rowGap }}>
                      ...
                      style={
                        {
                          ...
                          animationDirection: heading === "left" ? "normal" : "reverse",
