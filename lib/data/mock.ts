...
import { fromStudioLocal, studioWeek } from "@/lib/utils/studio-time";
...
function classSlot(
  ...
  const starts = fromStudioLocal(slot.year, slot.month, slot.day, hour);
...
export const mockProducts: Product[] = [
  {
    ...
    description:
      "The tee you train in. Clean REFORGE mark, built for the floor. Sample catalog piece until live product data is connected.",
    category: "t-shirts",
    priceCents: 3500,
    currency: "EUR",
    sizes: ["S", "M", "L", "XL"],
    variants: [
      { id: "p-tee-s", size: "S", stock: 12 },
      { id: "p-tee-m", size: "M", stock: 12 },
      { id: "p-tee-l", size: "L", stock: 12 },
      { id: "p-tee-xl", size: "XL", stock: 8 },
    ],
    image: "/images/store/hero.webp",
    images: [
      "/images/store/hero.webp",
      "/images/gym/reforge-store.webp",
      "/images/gym/studio-floor.webp",
    ],
    featured: true,
    details: "Ships in Cyprus. Pickup at City Box Gym, Limassol.",
    materials: "Sample catalog — materials confirmed from the live store.",
  ...
  },
  {
    ...
    description:
      "The layer for before and after the session. REFORGE hoodie from the sample catalog.",
    category: "hoodies",
    priceCents: 6500,
    currency: "EUR",
    sizes: ["S", "M", "L", "XL"],
    variants: [
      { id: "p-hoodie-s", size: "S", stock: 8 },
      { id: "p-hoodie-m", size: "M", stock: 10 },
      { id: "p-hoodie-l", size: "L", stock: 10 },
      { id: "p-hoodie-xl", size: "XL", stock: 6 },
    ],
    image: "/images/gym/kettlebell-athlete.webp",
    images: [
      "/images/gym/kettlebell-athlete.webp",
      "/images/gym/urban-gym.webp",
      "/images/training/strength.webp",
    ],
    featured: true,
    details: "Ships in Cyprus. Pickup at City Box Gym, Limassol.",
    materials: "Sample catalog — materials confirmed from the live store.",
  ...
  },
  {
    ...
    description: "Session socks from the REFORGE sample catalog. Details confirmed from the live store.",
    category: "socks",
    priceCents: 1400,
    currency: "EUR",
    sizes: ["S/M", "L/XL"],
    variants: [
      { id: "p-socks-sm", size: "S/M", stock: 20 },
      { id: "p-socks-lxl", size: "L/XL", stock: 20 },
    ],
    image: "/images/gym/iron-plates.webp",
    images: ["/images/gym/iron-plates.webp", "/images/gym/studio-floor.webp"],
    featured: true,
    details: "Ships in Cyprus. Pickup at City Box Gym, Limassol.",
    materials: "Sample catalog — materials confirmed from the live store.",
    isPlaceholderPrice: true,
  },
  {
    ...
    name: "REFORGE Hat",
    subtitle: "Studio cap",
    description: "REFORGE cap from the sample catalog. Wear the work off the floor.",
    category: "headwear",
    priceCents: 2800,
    currency: "EUR",
    sizes: ["OS"],
    variants: [{ id: "p-hat-os", size: "OS", stock: 16 }],
    image: "/images/gym/rack-dumbbells.webp",
    images: [
      "/images/gym/rack-dumbbells.webp",
      "/images/gym/kettlebell-still.webp",
      "/images/gym/kettlebell-portrait.webp",
    ],
    featured: true,
    details: "Ships in Cyprus. Pickup at City Box Gym, Limassol.",
    materials: "Sample catalog — materials confirmed from the live store.",
